        ...
        <article className="wrapper">
          ...
          <div className="introduction">
            ...
            <p className="description">
              Yayasan Cipta Mandiri (YCM) is an Independent Creative Foundation
              for disadvantaged children and youth in Bogor, West Java,
              Indonesia. Rather than being a traditional academic school, YCM is
              a rumah pembinaan - a house in which students are able to build
              their self-confidence, general knowledge, and practical skills.
            </p>
